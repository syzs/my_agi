...
def plt_intuition(x_train, y_train):
    ...
    print(f'w_range {w_range} {w_range.shape[0]}') # [0 400] 2
    tmp_b = 100

    w_array = np.arange(*w_range, 5) # [0.400) step=5 -> [0...395]
    print(f'w_array {w_array} {w_array.shape[0]}')
    cost = np.zeros_like(w_array)
    print(f'cost {cost} {cost.shape[0]}') # [0...0] 80
